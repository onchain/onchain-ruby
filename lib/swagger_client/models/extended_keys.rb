...
module SwaggerClient
  ...
  class ExtendedKeys
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'master_keys')
        if (value = attributes[:'master_keys']).is_a?(Array)
          self.master_keys = value
        end
      end
    ...
    def hash
      [master_keys, number_of_required_signatures].hash
    end
